    ...
    "2": {
        ...
        elements: [
         ...
         
            {
              startTime: 10,
              duration: 5,
              layer: {type: "news-title", text: "Breaking News2", fontPath: "./assets/Patua_One/PatuaOne-Regular.ttf" }
            }
        ]
    },
    ...
    "3": {
        ...
        elements: [
         ...
         
            {
              startTime: 10,
              duration: 5,
              layer: {type: "subtitle", text: "Multi-track & multi-scene demo", position: { y: 0.92 }, textColor: "#dddddd", fontPath: "./assets/Patua_One/PatuaOne-Regular.ttf" }
            }
        ]
    }
